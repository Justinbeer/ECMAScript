...
// 객체 생성방법 2: JSON(JavaScript Object Notation)
console.log("==================== JSON");
const person2 = {
    // 키 : 값
    name : "홍길동",
...
// JSON은 JS 객체 표기에도 중요하지만, 데이터 포맷으로도 사용되기 때문에 중요
...
// 여러 인스턴스들이 공유 메모리영역인 prototype 영역에 공용속성,
// 메서드를 구현하면 모든 인스턴스들이 사용할 수 있다
